...
public class User {
	...
	public String toString() {
		return "User [user_id=" + user_id + ", user_name=" + user_name + ", user_pwd=" + user_pwd + ", user_phone="
				...
				+ ", user_validatecode=" + user_validatecode + ", penFriendSet=" + penFriendSet + ", followSet="
				+ followSet + ", followTypeSet=" + followTypeSet + ", invitationSet=" + invitationSet + ", collectSet="
				+ collectSet + ", commentSet=" + commentSet + ", replySet=" + replySet + ", letterSet=" + letterSet
				+ ", getLetterSet=" + getLetterSet + ", voiceScreamSet=" + voiceScreamSet + ", textShoutSet="
				+ textShoutSet + "]";
	}
